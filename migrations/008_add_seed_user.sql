-- Migration: Ensure seed user function exists
-- This function will be called by the application to create a seed user with the API_TOKEN
...
BEGIN
    ...
    -- Create seed user with API token
    INSERT INTO users (email, api_token, organization_id, display_name, role, is_active)
    VALUES (
        'seed@localhost',
        api_token_value,
        org_id,
